...
<%
          ...
          mtbl.setConectar();
          ResultSet rsSubscribers=mtbl.getQuery("select * from information_schema.tables where table_schema='public' ");
          mtbl.setDesconectar(); 
%>
<!DOCTYPE html>
...
<head>
	<meta charset="utf-8" />
	<title>Test Site | Manage Database</title>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Manage Customer Database <small>Back Customer Database</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="#">Manage Customer Database</a></li>
						</ul>
					...
					<div class="span12">
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<div class="caption"><i class="icon-user"></i>View Database/Tables</div>
								<div class="actions">
									<div class="btn-group">
										...
										<div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
											<label><input type="checkbox" checked data-column="0">Database</label>
											<label><input type="checkbox" checked data-column="1">Table</label>
										</div>
									</div>
								</div>
							</div>
							<div class="portlet-body">
									...
									<div class="btn-group">
										<a class=" btn green" href="/rsvp/assets/backup/webglobal.backup">Backup System Database</a>
									</div>
								...
								<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
									...
									<tbody>
										...
										<tr>
											<td><%=rsSubscribers.getString("table_catalog")%></td>
											<td><%=rsSubscribers.getString("table_name")%></td>
											
                                                                                        <td><a class="edit" href="#notImplementedId">view</a></td>
											<td><a class="delete" href="#notImplementedId">backup</a></td>
										</tr>
										<%
                                                                                    }
                                                                                %>
