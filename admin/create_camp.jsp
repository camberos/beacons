											...
											<div class="navbar-inner">
												<ul class="row-fluid">
													...
													<li class="span3">
														...
														<span class="desc"><i class="icon-ok"></i>Subscriber Selection</span>   
														</a>
													</li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="control-group">
													...
													<div class="controls">
                                                                                                            <input id="campaignName" type="text" class="span6 m-wrap" name="campaignName"/>
														<span class="help-inline">Provide the campaign name</span>
													</div>
												</div>
												
												<div class="control-group">
													<label class="control-label">Closing Date<span class="required">*</span></label>
													<div class="controls">
														<input class="m-wrap" size="16" type="text" name="dateEnd" value="" id="ui_date_picker"/>
														<span class="help-inline">Provide the date</span>
													</div>
												</div>
											</div>
											<div class="tab-pane" id="tab2">
												<h3 class="block">Provide fields for your form</h3>
												
												
												<div class="control-group">
													<label class="control-label">Fields<span class="required">*</span></label>
													<div class="controls">
													
                                                                                                                <label class="checkbox">
                                                                                                                    <input type="checkbox" value="check" checked="" disabled="" /> Name
														</label>
                                                                                                                
                                                                                                                <div></div>
                                                                                                                
                                                                                                                <label class="checkbox">
                                                                                                                    <input type="checkbox" value="check" checked="" disabled="" /> Surname
														</label>
                                                                                                                
                                                                                                                <div></div>
                                                                                                                
                                                                                                                <label class="checkbox">
                                                                                                                    <input type="checkbox" value="check" checked="" disabled="" /> Company
														</label>
                                                                                                                
                                                                                                                <div></div>
                                                                                                                
                                                                                                                <label class="checkbox">
                                                                                                                    <input type="checkbox" value="check" checked="" disabled="" /> Email
														</label>
                                                                                                                
                                                                                                                <div></div>
                                                                                                                
                                                                                                                <label class="checkbox">
                                                                                                                    <input type="checkbox" value="check" checked="" disabled="" /> Contact Number
														</label>
                                                                                                                
                                                                                                                <div></div>
                                                                                                            
                                                                                                                <label class="checkbox">
                                                                                                                <input type="checkbox" value="check" name="checkFields1" id="checkFields1Id" /> Bring Partner
														</label>
                                                                                                                
                                                                                                                <div></div>
                                                                                                                
                                                                                                                <label class="checkbox">
                                                                                                                    <input type="checkbox" value="check" name="checkFields1" id="checkFields2Id" disabled="" /> Partner First Name
														</label>
                                                                                                                
                                                                                                                <div></div>
                                                                                                            
                                                                                                                <label class="checkbox">
                                                                                                                    <input type="checkbox" value="check" name="checkFields1" id="checkFields3Id" disabled="" /> Partner Last Name
														</label>
                                                                                                               
                                                                                                                <div></div>
                                                                                                                
														<label class="checkbox">
														<input type="checkbox" value="check" name="checkFields4" id="checkFields4Id" /> Comments
                                                                                                                </label>
                                                                                                                
                                                                                                                <div></div>
                                                                                                                
                                                                                                                <label class="checkbox">
                                                                                                                <input type="checkbox" value="check" name="checkFields5" id="checkFields5Id"/> Travel
														</label>
                                                                                                                
                                                                                                                <div></div>
                                                                                                                
														<label class="checkbox">
														<input type="checkbox" value="check" name="checkFields6" id="checkFields6Id" /> Accommodation
                                                                                                                </label>
													</div>
												</div>
											...
											<div class="tab-pane" id="tab3">
												<h3 class="block">Add Customers to your Campaign</h3>
												<!-- BEGIN EXAMPLE TABLE PORTLET-->
                                                                                        ...
                                                                                        <div class="tab-pane" id="tab5">
                                                                                            <h3 id="ConfirmLabel" class="block">Confirm and Submit Form </h3>
                                                                                            
                                                                                                <div id="FormResult" class="control-group">
                                                                                                        <label class="control-label">Attach Image</label>
                                                                                                        <div class="controls">
                                                                                                            <select id="selectImageId" class="span6 m-wrap" data-placeholder="Choose a Category" tabindex="1" name="uploadfile">
                                                                                                                        <option selected="">Select Image</option>
                                                                                                                        <%
                                                                                                                        while(rsImages.next()){
                                                                                                                        %>
                                                                                                                        <option value="<%=rsImages.getString("filename")%>"><%=rsImages.getString("filename")%></option>
                                                                                                                        <%
                                                                                                                        }
                                                                                                                        %>
                                                                                                                </select>
                                                                                                            <div id="displaySelectedImageId"></div>
                                                                                                        </div>
	...
	<script>
		jQuery(document).ready(function() {       
		   ...
		   FormWizard.init();
                   ...
                   $("#selectImageId").change(function() {
                         var selectedImage = $("#selectImageId").val();
                         var url = "viewImage.jsp?selectedImage="+selectedImage+""; // the script where you handle the form input.
                            $.ajax({
                                   type: "GET",
                                   url: url,
                                   async:false,
                                   //data: $("").serialize(), // serializes the form's elements.
                                   success: function(data)
                                   {
                                       $("#displaySelectedImageId").html(data);
                                       //alert("success");
                                   }
                                 });
