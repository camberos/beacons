...
<%
          ...
          String sHTML="<!DOCTYPE html>";
                 ...
                 sHTML+="<a href=\"http://"+ip+":"+port+"/"+webapp+"/robot/index.html\"><img border=\"0\" src=\"http://"+ip+":"+port+"/"+webapp+"/download/"+uploadfile+"?id=uniqueid\" alt=\"Click Me!\" width=\"758\" height=\"971\"></a>";
                 sHTML+="</body>";
                 sHTML+="</html>";
          ...
          while(rsSubscribers.next()){
              if(rsSubscribers.getString("sub_id").equals(request.getParameter("subscribers"+rsSubscribers.getString("sub_id")+""))){
                  ...
                  data= "nextval('campinfo_info_id_seq'::regclass),"+campId+" , "+rsSubscribers.getString("sub_id")+" , "+attrId+" ,null"; // Attribute Data String
                  //out.print(data+"\r");
          ...
          out.println("<h4 class=\"alert-heading\">Saved!</h4>");
          out.println("<p>");
          out.println("");
          out.println("");
          out.println("</p>");
